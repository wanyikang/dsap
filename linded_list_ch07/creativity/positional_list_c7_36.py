from doubly_linked_list_without_sentinel import DoublyLinkedList
...
class PositionalList(DoublyLinkedList):
    ...
    def add_first(self, e):
        ...
        return self._insert_between(e, None, self._head)

    def add_last(self, e):
        """Insert element e at the back of the list and return new Position."""
        return self._insert_between(e, self._tail, None)
...
if __name__ == '__main__':
    ...
    print(pl.before(pl.last()).element())
    print(pl.after(pl.first()).element())
